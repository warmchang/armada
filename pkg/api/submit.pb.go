...
const (
	IngressType_NodePort IngressType = 0
)
...
type JobReprioritizeResponse struct {
	ReprioritizationErrors map[string]string `protobuf:"bytes,1,rep,name=reprioritization_errors,json=reprioritizationErrors,proto3" json:"reprioritizationErrors,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *JobReprioritizeResponse) GetReprioritizationErrors() map[string]string {
	if m != nil {
		return m.ReprioritizationErrors
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "api.JobReprioritizeResponse.ReprioritizationErrorsEntry")
...
var fileDescriptor_e998bacb27df16c1 = []byte{
	...
	,
}
...
func (m *JobReprioritizeResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ReprioritizationErrors) > 0 {
		for k := range m.ReprioritizationErrors {
			v := m.ReprioritizationErrors[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintSubmit(dAtA, i, uint64(len(v)))
...
func (m *JobReprioritizeResponse) Size() (n int) {
	...
	_ = l
	if len(m.ReprioritizationErrors) > 0 {
		for k, v := range m.ReprioritizationErrors {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovSubmit(uint64(len(k))) + 1 + len(v) + sovSubmit(uint64(len(v)))
			n += mapEntrySize + 1 + sovSubmit(uint64(mapEntrySize))
...
func (this *JobReprioritizeResponse) String() string {
	...
	keysForReprioritizationErrors := make([]string, 0, len(this.ReprioritizationErrors))
	for k, _ := range this.ReprioritizationErrors {
		keysForReprioritizationErrors = append(keysForReprioritizationErrors, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForReprioritizationErrors)
	mapStringForReprioritizationErrors := "map[string]string{"
	for _, k := range keysForReprioritizationErrors {
		mapStringForReprioritizationErrors += fmt.Sprintf("%v: %v,", k, this.ReprioritizationErrors[k])
	}
	mapStringForReprioritizationErrors += "}"
	s := strings.Join([]string{`&JobReprioritizeResponse{`,
		`ReprioritizationErrors:` + mapStringForReprioritizationErrors + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *JobReprioritizeResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReprioritizationErrors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReprioritizationErrors == nil {
				m.ReprioritizationErrors = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.ReprioritizationErrors[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSubmit(dAtA[iNdEx:])
