...
func request_Lookout_CancelJobSet_0(ctx context.Context, marshaler runtime.Marshaler, client LookoutClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CancelJobSetRequest
	var metadata runtime.ServerMetadata
...
func local_request_Lookout_CancelJobSet_0(ctx context.Context, marshaler runtime.Marshaler, server LookoutServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CancelJobSetRequest
	var metadata runtime.ServerMetadata
...
func RegisterLookoutHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LookoutServer) error {
	...
	mux.Handle("POST", pattern_Lookout_CancelJobSet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_Lookout_CancelJobSet_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_Lookout_CancelJobSet_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterLookoutHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LookoutClient) error {
	...
	mux.Handle("POST", pattern_Lookout_CancelJobSet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Lookout_CancelJobSet_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Lookout_CancelJobSet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "lookout", "cancel_job_set"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_Lookout_CancelJobSet_0 = runtime.ForwardResponseMessage
)
